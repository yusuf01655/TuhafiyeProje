...
public class IdIleMusteriGosterFE implements FeInterfaces {

	public IdIleMusteriGosterFE() {
	...
	public void initPencere() {
		try {
			...
			AnchorPane root = (AnchorPane) FXMLLoader
					.load(getClass().getResource("/tr/com/yusuf/fe/IdIleMusteriGosterFE.fxml"));
